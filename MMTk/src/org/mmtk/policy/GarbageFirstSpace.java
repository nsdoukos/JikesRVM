 ...
 * are static.
 */
@Uninterruptible public final class GarbageFirstSpace extends Space {
   ...
   */
  public GarbageFirstSpace(String name, VMRequest vmRequest) {
   ...
   * @param vmRequest An object describing the virtual memory requested.
   */
  public GarbageFirstSpace(String name, boolean zeroed, VMRequest vmRequest) {
